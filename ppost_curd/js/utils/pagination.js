 ...
 export function initPaginate({elementId,defaultParams,onchangeValue}) {
    ...
    clickPrev.addEventListener("click", function(event) {
                        ...
                        for (const element of clickPage) {
                            if(element.firstElementChild.getAttribute("data-page") == search.get('_page')) element.classList.add('active') 
                        }
                    });
    ...
    for (const element of clickPage) {
    if(element.firstElementChild.getAttribute("data-page") == defaultParams.get('_page')) element.classList.add('active') 
